                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12">
                                    <input type="email" id="email" name="email"
                                        placeholder="Enter email ID or phone number" autocomplete="off"
                                        class="float-input mb-5" value="aakashmehrafs@gmail.com" required>
                                ...
                                <div class="form-group col-lg-6">
                                    <input type="text" name="last_name" placeholder="Second name" value=""
                                ...
                                <div class="form-group col-lg-12">
                                    <input type="text" name="street" placeholder="Enter your street" value=""
                                        autocomplete="off" class="float-input mb-5" required>
                                ...
                                <div class="form-group col-lg-4">
                                    <input id="pincodedata" oninput="enforcePincodeLength(event)" type="text"
                                        name="pincode" placeholder="Pincode" autocomplete="off" class="float-input mb-5"
                                        value="" required>
                                ...
                                <div class="d-flex justify-content-between align-items-center up-and-down"
                                    ...
                                    <button type="submit" class="hand-button">
                                        <a href="./OrderView.html"
                                            style="text-decoration: none; color: #fff;">Continue</a>

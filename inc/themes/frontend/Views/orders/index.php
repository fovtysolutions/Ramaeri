...
<section class="categories-section">
    <div class="containerssss">
        <form id="final_order">
                ...
                <div class="col-lg-7 col-md-12 contact-section">
                    ...
                    <div class="payment-sec-txt">
                        <div class="payment-option">
                            <label for="razorpay" style="width:100%">
                                <div class="row">
                                    <input type="hidden" name="razor" id="razor">
                                    <div class="col-md-6 col-6">
                                        <div class="d-flex">
                                            <input type="radio" id="razorpay" name="payment_method" value="Online"
                                                checked>
                                            <input type="hidden" id="methodcheck" value="">
                                    ...
                                    <div class="col-md-6 col-6" style="text-align:right">
                                        <div class="payment-icons">
                                            <img src="https://ramaeri.com/storage/app/public/images/visa-icon.png"
                                                alt="Visa" style="">
                                            <img src="https://ramaeri.com/storage/app/public/images/mster.png"
                                                alt="RuPay" style="">
                        ...
                        <div class="option-description d-flex flex-column text-center payment-method"
                            ...
                            <img src="https://ramaeri.com/storage/app/public/images/redirect-icon.png"
                                alt="Redirect Icon" class="w-25">
                        ...
                        <div class="payment-method pay-later d-flex gap-2">
                            <input type="radio" id="simpl" name="payment_method" value="Partially">
                            <label for="simpl" style="font-weight:700;">
                    ...
                    <div class="payment-sec-txt">
                        ...
                        <div class="address-option pay-later">
                            <button type="button" class="billing-address" style="font-weight: 700;"
                ...
                <div class="col-lg-5 col-md-12 cart-section cart-checkout"
                    ...
                    <div
                        ...
                        <div class="pricing-info pt-3">
                            ...
                            <div class="subtotals sub-total-price" id="carttotals">₹</div>
                        </div>
                    ...
                    <div class="pricing-info pt-9" id="pricing_del">
                        ...
                        <div class="subtotalss sub-total-price" id="totalsamount">₹</div>
                        <input type="hidden" name="total_amount" id="totalsamounts">
                    </div>
                        ...
                        <div class="col-12 col-lg-4 pt-8 pb-8 down-and-up">
                            ...
                            <button type="submit" class="hand-button">
                                ...
                                <img src="https://ramaeri.com/storage/app/public/images/Component1.png" alt="Arrow Icon"
                                    class="btn-arrow" style="height:20px;width:20px">
                            </button>
                        </div>
                    </div>
            ...
            <input type="hidden" name="order_email" id="emailname"
                value="<?php echo $productdata['session_data']['email'] . ' ' . $productdata['session_data']['last_name'] ?>">
            <input type="hidden" name="order_name" id="username"
                value="<?php echo $productdata['session_data']['first_name'] . ' ' . $productdata['session_data']['last_name'] ?>">
        </form>
        </d>
</section>
<input type="hidden" id="razorpayid" value="" name="razorpay_payment_id">
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 500px;">
        <div class="modal-content text-center p-4 p-md-5" style="color: #267a2d;">
            <div class="fireworks-icon">
                <img style="width: 100px; height:100px;" src="<?php echo base_url('/assets/public/img/flower.jpg') ?>"
                    class="img-fluid" alt="Fireworks Icon">
            ...
            <div class="text-center continue-link mt-4" style="font-weight: 500;">
                <a href="<?php echo base_url('products') ?>" style="color: #4A6437;"><span>Click Here To
                        Continue</span></a>
            </div>
        </div>
    </div>
                ...
                <form id="addAddressForm">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="emka" name="email" value="" required>

                        </div>
                        <div class="col-md-12">
                            <label for="countryName" class="form-label">First Name</label>
                            <input type="text" class="form-control" id="countryName" name="first_name" value=""
                                required>

                        </div>
                        <div class="col-md-12">
                            <label for="countryName" class="form-label">Contact</label>
                            <input type="text" class="form-control" id="countryName" name="number" value="" required>

                        </div>
                        <div class="col-md-12">
                            <label for="countryName" class="form-label">Country</label>
                            <input type="text" class="form-control" id="countryName" name="country" value="" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="city" name="building" value="" required>
                        </div>
                        <div class="col-md-12">
                            <label for="city" class="form-label">Street</label>
                            <input type="text" class="form-control" id="city" name="street" value="" required>
                        </div>
                        <div class="col-md-12">
                            <label for="city" class="form-label">Landmark</label>
                            <input type="text" class="form-control" id="city" name="landmark" value="" required>
                        </div>
                        <div class="col-md-12">
                            <label for="zip" class="form-label">PinCode</label>
                            <input type="text" class="form-control" id="zip" name="pincode" value="" required>
                        </div>
                        <div class="col-12">
                            <label for="addressLine" class="form-label">Address</label>
                            <input type="textArea" class="form-control" id="addressLine" name="address" value=""
                                required>
                        </div>
...
<script>
    $(document).ready(function () {
        function initRazor(total_amount, email, description, name) {
            var options = {
                "key": 'rzp_test_IAvCVm6VpijZ89',
                // "key": 'rzp_live_nyLAmBDWesL2p6',
                ...
                "handler": function (response) {
                    if (response && response.razorpay_payment_id) {
                        ...
                        toastr.error('Due to some resion your order is cancled please make it again!!')
                    }
                },
                "prefill": {
        ...
        $("#final_order").submit(function (e) {
            ...
            const payonline = $('#methodcheck').val();
            let name = $('#username').val();
            let description = "Online Booking";
            let email = $('#emailname').val();
            let total_amount = $('#totalsamounts').val();

            if (payonline == 'online') {
                initRazor(total_amount, email, description, name);
                $('#methodcheck').val('');
                return;
            }
            ...
            // Collect form data
            let form = document.getElementById("final_order");
            ...
            $.ajax({
                ...
                contentType: false,
                beforeSend: function () {
                    $("#final_order_btn").text("Please wait...");
                },
                ...
                error: function () {
                    ...
                    $("#final_order_btn").text("Place Order");
                }
            });
        });
    });
    ...
    function joinaddtocartss(arrayhere, divID, baseurl) {
        if (arrayhere.length > 0) {
            ...
            let result = arrayhere.map((details, index) => {
                ...
                <input type="hidden" name="cart_id[]" value="${details.id}">
                    <div>
                    ...
                    <div class="w-100">
                        ...
                        <div class="add-item pb-5">
                            <button type="button" data-decid="${details.id}" class="decrease dec">-</button>
                            ...
                            <button type="button" data-incid="${details.id}" class="decrease inc" >+</button>
                        </div>

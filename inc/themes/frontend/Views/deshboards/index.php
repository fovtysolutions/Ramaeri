                ...
                <div class="col-12 col-md-3 col-xl-2">
                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                        ...
                        <div style="text-align:center;margin-bottom:-2rem">
                            <button class="nav-link active" id="home-tab"><span id="profilespan"
                        ...
                        <div class="">
                            ...
                            <button class="nav-link" id="settings-tab"><a href="#" style="all:unset"><span
                                        style="font-size:1.5rem;color:#c4d0bb">&#x2022;</span> Logout</a></button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="p-txt-cnt">
                                <div class="row align-items-center"
                                    ...
                                    <div class="col-2 col-md-2 col-xl-2 d-flex float-end"
                                        style="text-align: right !impportant;">
                                        ...
                                        <button class="edit-btn" onclick="openUpdateProfileModal()">Edit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <form action="#" method="POST" id="modal_address">
                    ...
                    <div class="form-group">
                        ...
                        <input type="integer" class="form-control" id="mobile" name="mobile" required maxlength="10"

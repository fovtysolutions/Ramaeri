<?php
namespace Core\SMTPsettings\Controllers;
use App\Controllers\PeginationController;

class SMTPsettings extends \CodeIgniter\Controller
{
    public function __construct(){
        $this->config = include realpath( __DIR__."/../Config.php" );
        $this->model = new \Core\SMTPsettings\Models\SMTPsettingsModel();
        $this->db = \Config\Database::connect();
        $this->master = "smtpsettings";
    }
    
    public function index()
    {
        $master = $this->master;
        $detailsModel = $this->model->getById(2);
        $id = $detailsModel->id;
        $addDatas = [   
                        'dashboard' => $master,
                        'title' => $master, 
        ...
        $data = [
            ...
            "content" => view('Core\SMTPsettings\Views\content', $addDatas)
        ];
        return view('Core\SMTPsettings\Views\index', $data);
    }
    ...
    public function get()
    {
        ...
        $data = $builder->where('type !=', null)->get()->getResultArray();
    ...
    public function SMTPsettingssearch()
    {
        $searchMain = $this->request->getVar('allData');

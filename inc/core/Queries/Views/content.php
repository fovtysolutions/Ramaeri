                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="product-categories" data-choices data-choices-groups
                                    ...
                                    <option value="" <?= empty($detailsdata->category) ? 'selected' : '' ?>>Select
                                        Product</option>
                                    <option value="Electronic" <?= (isset($detailsdata->category) && $detailsdata->category == 'Electronic') ? 'selected' : '' ?>>Electronic</option>
                                    <option value="Frueitce" <?= (isset($detailsdata->category) && $detailsdata->category == 'Frueitce') ? 'selected' : '' ?>>Frueitce</option>
                                </select>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="product-categories" data-choices data-choices-groups
                                    ...
                                    <option value="" <?= empty($detailsdata->product) ? 'selected' : '' ?>>Select
                                        Product</option>
                                    <option value="mouse" <?= (isset($detailsdata->product) && $detailsdata->product == 'mouse') ? 'selected' : '' ?>>mouse</option>
                                    <option value="keybord" <?= (isset($detailsdata->product) && $detailsdata->product == 'keybord') ? 'selected' : '' ?>>keybord</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<?php _ec($this->include('Core\Queries\Views\submitit'), false) ?>

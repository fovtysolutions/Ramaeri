...
class QueriesModel extends Model
{
    ...
    {
        $builder = $this->db->table('ramaeri_queries');
    ...
    public function getById($id){
        $query = $this->db->table('ramaeri_queries')->where('id', $id)->get();
        return $query->getRow(); 
    }
    ...
    public function updateit($id, $data)
    {
        ...
        return $this->db->table('ramaeri_queries')->where('id', $id)->update($data);
    }

    public function insertit($data)
    {
        return $this->db->table('ramaeri_queries')->insert($data);
    }

    public function deleteit($id)
    {
        return $this->db->table('ramaeri_queries')->where('id', $id)->delete();
    }
}

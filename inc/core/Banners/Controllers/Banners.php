<?php
namespace Core\Banners\Controllers;
use App\Controllers\PeginationController;

class Banners extends \CodeIgniter\Controller
{
    public function __construct(){
        $this->config = include realpath( __DIR__."/../Config.php" );
        $this->model = new \Core\Banners\Models\BannersModel();
    ...
    public function index()
    {
        ...
        $data = [
            ...
            "content" => view('Core\Banners\Views\Bannerslist', $mainDetails)
        ];
        return view('Core\Banners\Views\index', $data);
    }
    ...
    public function get()
    {
        ...
        $data = $builder->where('home_image IS NOT NULL')->get()->getResultArray();
    ...
    public function edit($id)
    {
        ...
        $data = [
            "title" => $this->config['name'],
            "desc" => $this->config['desc'],
            "content" => view('Core\Banners\Views\content', $addDatas)
        ];
        return view('Core\Banners\Views\index', $data);
    }

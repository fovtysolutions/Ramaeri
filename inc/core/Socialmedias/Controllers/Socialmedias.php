<?php
namespace Core\Socialmedias\Controllers;
use App\Controllers\PeginationController;

class Socialmedias extends \CodeIgniter\Controller
{
    public function __construct(){
        $this->config = include realpath( __DIR__."/../Config.php" );
        $this->model = new \Core\Socialmedias\Models\SocialmediasModel();
        $this->db = \Config\Database::connect();
        $this->master = "socialmedias";
    }
    
    public function index()
    {
        $master = $this->master;
        $detailsModel = $this->model->getById(4);
        $id = $detailsModel->id;
        $addDatas = [   
                        'dashboard' => $master,
                        'title' => $master, 
        ...
        $data = [
            ...
            "content" => view('Core\Socialmedias\Views\content', $addDatas)
        ];
        return view('Core\Socialmedias\Views\index', $data);
    }
    ...
    public function Socialmediassearch()
    {
        $searchMain = $this->request->getVar('allData');

...
class Categories extends \CodeIgniter\Controller
{
    public function __construct(){
        ...
        $this->model = new \Core\Categories\Models\CategoriesModel();
    ...
    public function index()
    {
        ...
        $mainDetails = [   
            ...
            'th'=>["Categories name","Brand", "Priority", "Themes"],
            'mainid'=> "get$master",
            'addbtnroute'=> "$master/add",
            'routeURL'=> "$master/get",
            'editroute'=> "/$master/edit/",
            'deleteURL'=> "$master/deleteit",
            'td'=>json_encode(["name","brand","priority","theme"]),
        ];
        $data = [
            "title" => $this->config['name'],
            "desc" => $this->config['desc'],
            "content" => view('Core\Categories\Views\Categorieslist', $mainDetails)
        ];
        return view('Core\Categories\Views\index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            "title" => $this->config['name'],
            "desc" => $this->config['desc'],
            "content" => view('Core\Categories\Views\content', $addDatas)
        ];
        return view('Core\Categories\Views\index', $data);
    }

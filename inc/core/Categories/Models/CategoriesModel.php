...
class CategoriesModel extends Model
{
    ...
    {
        $builder = $this->db->table('ramaeri_Categories');
    ...
    public function getById($id){
        $query = $this->db->table('ramaeri_Categories')->where('id', $id)->get();
        return $query->getRow(); 
    }
    ...
    public function updateit($id, $data)
    {
        ...
        return $this->db->table('ramaeri_Categories')->where('id', $id)->update($data);
    }

    public function insertit($data)
    {
        return $this->db->table('ramaeri_Categories')->insert($data);
    }

    public function deleteit($id)
    {
        return $this->db->table('ramaeri_Categories')->where('id', $id)->delete();
    }
}

<?php
namespace Core\Paymentmethods\Controllers;
use App\Controllers\PeginationController;

class Paymentmethods extends \CodeIgniter\Controller
{
    public function __construct(){
        $this->config = include realpath( __DIR__."/../Config.php" );
        $this->model = new \Core\Paymentmethods\Models\PaymentmethodsModel();
        $this->db = \Config\Database::connect();
        $this->master = "paymentmethods";
    }
    
    public function index()
    {
        $master = $this->master;
        $builder = $this->model->getSearchAll();
        ...
        $data = [
            ...
            "content" => view('Core\Paymentmethods\Views\content', $addDatas)
        ];
        return view('Core\Paymentmethods\Views\index', $data);
    }

<?php
namespace Core\Generalsettings\Models;
...
class GeneralsettingsModel extends Model
{
    ...
    public function getById($id){
        $query = $this->db->table('setting')->where('id', $id)->get();
        return $query->getRow(); 
    }
    ...
    public function updateit($id, $data)
    {
        ...
        return $this->db->table('setting')->where('id', $id)->update($data);
    }
    ...
    {
        return $this->db->table('setting')->where('id', $id)->delete();
    }
}

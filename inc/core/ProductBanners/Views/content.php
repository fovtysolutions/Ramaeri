                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="product-name" class="form-control" placeholder="Items Name" >
                                        <input type="hidden" name="product_image" id="imagename" value="<?= isset($detailsdata->product_image) ? $detailsdata->product_image : '' ?>">
                                </div>
                            </div>
                        </div>
                        <img src="<?= isset($detailsdata->product_image) ? base_url('/writable/'.$detailsdata->product_image) : '' ?>" alt="" srcset="" width="75px">
                    </div>
                </div>
...
<?php _ec($this->include('Core\ProductBanners\Views\submitit'), false) ?>

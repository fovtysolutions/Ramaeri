<?php
namespace Core\ProductBanners\Models;
use CodeIgniter\Model;

class ProductBannersModel extends Model
{
    ...
    {
        $builder = $this->db->table('ramaeri_Banners');
    ...
    public function getById($id){
        $query = $this->db->table('ramaeri_Banners')->where('id', $id)->get();
        return $query->getRow(); 
    }
    ...
    public function updateit($id, $data)
    {
        ...
        return $this->db->table('ramaeri_Banners')->where('id', $id)->update($data);
    }

    public function insertit($data)
    {
        return $this->db->table('ramaeri_Banners')->insert($data);
    }

    public function deleteit($id)
    {
        return $this->db->table('ramaeri_Banners')->where('id', $id)->delete();
    }
}

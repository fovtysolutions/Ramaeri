...
class ReviewsModel extends Model
{
    ...
    {
        $builder = $this->db->table('ramaeri_reviews');
    ...
    public function getById($id){
        $query = $this->db->table('ramaeri_reviews')->where('id', $id)->get();
        return $query->getRow(); 
    }
    ...
    public function updateit($id, $data)
    {
        ...
        return $this->db->table('ramaeri_reviews')->where('id', $id)->update($data);
    }

    public function insertit($data)
    {
        return $this->db->table('ramaeri_reviews')->insert($data);
    }

    public function deleteit($id)
    {
        return $this->db->table('ramaeri_reviews')->where('id', $id)->delete();
    }
}

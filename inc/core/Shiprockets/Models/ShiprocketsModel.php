<?php
namespace Core\Shiprockets\Models;
use CodeIgniter\Model;

class ShiprocketsModel extends Model
{
    ...
    {
        $builder = $this->db->table('ramaeri_providers');
    ...
    public function getById($id){
        $query = $this->db->table('ramaeri_providers')->where('id', $id)->get();
        return $query->getRow(); 
    }
    ...
    public function updateit($id, $data)
    {
        ...
        return $this->db->table('ramaeri_providers')->where('id', $id)->update($data);
    }

    public function insertit($data)
    {
        return $this->db->table('ramaeri_providers')->insert($data);
    }

    public function deleteit($id)
    {
        return $this->db->table('ramaeri_providers')->where('id', $id)->delete();
    }
}
